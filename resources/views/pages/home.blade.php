<x-guest-layout>
    <!-- Hero Section -->
    <section class="relative w-full h-[550px] flex items-center text-left justify-center bg-cover bg-center"
        style="background-image: url('{{ asset('images/exhibition.webp') }}');">
        <div class="bg-white p-8 rounded-lg shadow-lg text-left">
            ...
            <p class="text-gray-600 mt-2">Réservez la salle idéale pour vos événements : mariages, anniversaires et plus
            </p>.</p>
            <div class="mt-4 flex space-x-4">
                <a href="{{ route('halls.guest') }}" class="bg-primary text-white px-4 py-2 rounded">Voir plus</a>
                <button class="border border-green-600 text-green-600 px-4 py-2 rounded"><a
                        href="{{ route('blog') }}">Blog</a></button>
            </div>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto text-center py-16 px-4">
        <h2 class="text-4xl font-extrabold">L'avenir est flexible</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-8">
            ...
            @php
                $features = [
                    [
                        'icon' => 'fa-bed',
                        'title' => 'Espace Flexible',
                        'desc' => 'Nos salles s\'adaptent à vos besoins pour différents types d\'événements.',
                    ],
                    [
                        'icon' => 'fa-home',
                        'title' => 'Prêtes à l\'emploi',
                        'desc' => 'Des salles entièrement équipées et prêtes à accueillir vos invités.',
                    ],
                    [
                        'icon' => 'fa-wifi',
                        'title' => 'Wi-Fi Haut Débit',
                        'desc' => 'Restez connecté avec notre connexion Wi-Fi rapide et fiable.',
                    ],
                    [
                        'icon' => 'fa-headset',
                        'title' => 'Support 24/7',
            ...
            @foreach ($features as $feature)
                <div class="p-6 bg-[#E2F1E8] rounded-lg shadow-lg flex flex-col items-center text-center transition-transform transform hover:scale-105 hover:shadow-xl duration-300">
                    <i class="fas {{ $feature['icon'] }} text-4xl text-primary mb-4 transition-all duration-300 hover:text-indigo-800"></i>
    ...
    <section class="max-w-screen-xl mx-auto py-12 sm:px-4">
        <div class="container mx-auto my-10 text-center">
            ...
            <p class="text-lg text-gray-500 mb-12">
                Découvrez nos meilleures offres de location de salles de fête, sélectionnées avec soin pour vous offrir
                le meilleur rapport qualité-prix et une expérience inoubliable.
            </p>

            <!-- Grid avec centrage et responsivité améliorée -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 sm:mx-5">
                        ...
                        <div class="p-6 text-left">
                            ...
                            <div class="mt-6 flex justify-between items-center gap-4">
                                ...
                                <a href="{{ route('guest.hall.show', $hall->id) }}"
                                    class="bg-primary text-white text-sm font-semibold py-2 px-4 rounded-md flex items-center">
                                    <i class="fa fa-eye mr-2"></i> Voir
                                </a>

                                <!-- Bouton Contacter -->
                                <a href="tel:+229 62590775"
                                    class="bg-primary text-white text-sm font-semibold py-2 px-4 rounded-md flex items-center">
    ...
    <section class="max-w-7xl mx-auto py-16 px-4">
        <h2 class="text-4xl font-extrabold text-center mb-5">Choisissez votre type d'événement</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mt-10">
            ...
            @foreach ($eventTypes as $event)
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl duration-300">
                    <img src="{{ asset('images/' . $event['image']) }}" alt="{{ $event['name'] }}"
                        class="w-full h-48 object-cover">
                    <div class="p-6">
                        <h3 class="text-2xl font-semibold text-center text-gray-800">{{ $event['name'] }}</h3>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    <!-- Avantages -->
    <section class="bg-primary py-16 sm:px-5">
    ...
    <!-- Testimonials -->
    <section class="max-w-7xl mx-auto py-12 sm:px-5">
        ...
        <p class="text-lg text-center text-gray-500 mb-12">
            Découvrez pourquoi nos clients adorent organiser leurs événements avec nos salles de fête ! Lisez de
            véritables avis et témoignages pour voir comment nous offrons un service exceptionnel.
        </p>
            ...
            <div class="swiper-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:mx-12">
                ...
                <div class="swiper-slide">
                    <div class="client__card p-6 bg-white shadow-lg rounded-lg">
                        ...
                        <p class="text-gray-600">
                            Nous avons réservé une salle pour notre mariage, et l'expérience a été exceptionnelle.
                            L'équipe était très professionnelle et la salle était parfaitement préparée. Tous nos
                            invités ont été impressionnés par l'espace et la décoration.
                        </p>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="client__card p-6 bg-white shadow-lg rounded-lg">
                        ...
                        <p class="text-gray-600">
                            La salle était magnifique et parfaitement adaptée à notre événement. Nous avons organisé une
                            conférence et tout s'est déroulé sans accroc. La capacité d'accueil et les équipements
                            étaient parfaits. Une très bonne expérience !
                        </p>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="client__card p-6 bg-white shadow-lg rounded-lg">
                        ...
                        <p class="text-gray-600">
                            Nous avons célébré l'anniversaire de mon mari dans une de vos magnifiques salles. L'ambiance
                            était parfaite et la gestion de l'événement impeccable. Nous avons reçu de nombreux
                            compliments de la part de nos invités.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- CTA Final amélioré -->
    <section class="bg-primary text-white text-center py-16 sm:px-4">
        <h2 class="text-3xl font-bold">Rejoignez-nous dés maintenant !</h2>
