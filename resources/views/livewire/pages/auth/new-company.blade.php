<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-primary">
        ...
        <h1 class="font-semibold text-3xl text-white leading-tight my-6 text-center">
            <i class="fas fa-building text-white text-3xl px-2"></i> {{ __('Fournir les informations sur votre société') }}
        </h1>

        <div class="w-full sm:w-11/12 md:w-3/4 lg:w-2/4 my-6 p-6 sm:p-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
