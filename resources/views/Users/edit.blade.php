            ...
            <div class="bg-white overflow-x-scroll shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}" enctype="multipart/form-data">
                        ...
                        @method('PUT')
                        <div class="m-4">
                            <label for="avatar" class="block text-sm font-medium text-gray-700 text-xl">Photo de
                                profil</label>
                        ...
                        <!-- firstname -->
                        <div class="mb-4">
                            <label for="firstname" class="block text-sm font-medium text-gray-700 text-xl">Prenom*</label>
                        ...
                        <!-- lastname -->
                        <div class="mb-4">
                            <label for="lastname" class="block text-sm font-medium text-gray-700 text-xl">Nom*</label>
                        ...
                        <!-- gender -->
                        <div class="mb-4">
                            <label for="gender" class="block text-sm font-medium text-gray-700 text-xl">Genre</label>
                        ...
                        <!-- email -->
                        <div class="mb-4">
                            <label for="email" class="block text-sm font-medium text-gray-700 text-xl">Email</label>
                        ...
                        <!-- birthday -->
                        <div class="mb-4">
                            <label for="birthday" class="block text-sm font-medium text-gray-700 text-xl">Date de naissance</label>
                        ...
                        <!-- phone -->
                        <div class="mb-4">
                            <label for="phone" class="block text-sm font-medium text-gray-700 text-xl">Téléphone</label>
                        ...
                        <!-- address -->
                        <div class="mb-4">
                            <label for="address" class="block text-sm font-medium text-gray-700 text-xl">Adresse</label>
