<x-guest-layout>
    <div class="max-w-8xl mx-auto  p-10 ">
        ...
        <p class="text-lg text-gray-600 mb-6">Retrouvez tous vos Réservation !</p>
        </div>
            ...
            <div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    @foreach($events as $event)
                        <div class="flex flex-col p-6 bg-white border border-gray-300 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                            ...
                            <p class="text-gray-600"><strong>Lieu :</strong> {{ $event->location }}</p>
